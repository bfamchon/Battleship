...
Choisir ses bateaux de manière aléatoire ou les tourner en cliquant dessus (modifier la position n’est pas encore livrable)
...
Pour le moment pas livrable juste un aperçu des clicks (bug de position) 

II- TERMINER LE JEU

Cliquer siur la croix puis sur  «quitter » pour se déconnecter ou la croix
